...
def create_llm_prompt(data):
    ...
    **Environmental Data:**
    ...
    - Humidity: {weather.get('weather', {}).get('humidity_percent', 'N/A')}%
    - Air Quality (US EPA Index): {air_quality.get('us_epa_index', 'N/A')} (1=Good, 2=Moderate, 3=Unhealthy for Sensitive, 4=Unhealthy)
    - PM2.5: {air_quality.get('pm2_5', 'N/A')} µg/m³
...
# ... (/api/trends route remains unchanged) ...
